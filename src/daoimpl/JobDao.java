	...
	public void addJob(Job j){
		try {
			...
			if(i==1){
				...
				JOptionPane.showMessageDialog(g,"Unable to add a Job");
			}
		}
		catch(SQLException ex) {
			System.out.println(ex.getMessage());
	...
	public void deactivateJob(Job j) {
		try {
			...
			if(i==1){
				...
				JOptionPane.showConfirmDialog(g, " Deactivated successfully...");
				
			}
			else {
				System.out.println("Deactivation failed...");
				JOptionPane.showConfirmDialog(g, "Deactivation failed ");
	...
	public void activateJob(Job j) {
		try {
			...
			if(i==1){
				...
				JOptionPane.showConfirmDialog(g, "Job activated Succesfully...");
				
			}
			else {
				System.out.println("Activation failed...");
				JOptionPane.showConfirmDialog(g, " Activation Failed...");
