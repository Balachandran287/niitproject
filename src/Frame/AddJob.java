...
public class AddJob extends JFrame {
	...
	public AddJob() throws ClassNotFoundException, SQLException {
		...
		lJobtitle.setFont(new Font("Serif", Font.PLAIN, 15));
		lJobdescrip=new JLabel("Job Description");
		lJobdescrip.setFont(new Font("Serif", Font.PLAIN, 15));
		lCompanyname=new JLabel("Company Name");
		lCompanyname.setFont(new Font("Serif", Font.PLAIN, 15));
		lLocation=new JLabel("Location");
		lLocation.setFont(new Font("Serif", Font.PLAIN, 15));
		lKeyskill=new JLabel("Key Skill");
		lKeyskill.setFont(new Font("Serif", Font.PLAIN, 15));
